...
def index():
    ...
    def get_tracks_dic(tracks):
        ...
        return switched_artist_dic, result_dic, images, urls
    ...
    switched_artist_dic_16, result_dic_16, images_16, urls_16 = get_tracks_dic(tracks_2016)
    switched_artist_dic_17, result_dic_17, images_17, urls_17 = get_tracks_dic(tracks_2017)
    return render_template('index.html', rdic16=result_dic_16, imurl16=images_16,
                           artist_dic_sw16=switched_artist_dic_16, urls16=urls_16,
